...
export default function Home() {
  ...
  const theMonkeyMothershipVideoId: string = "q0RXd1Tj7tk";
  ...
  const [theMonkeyMothershipData] = filter(
  ...
  return (
    <section className="wrapper w-full min-h-[calc(100dvh-8rem)] overflow-x-hidden !mx-auto flex justify-center">
      <div className="inner flex-grow-0 w-full h-full !mb-10 !pt-4 md:!pt-10 max-md:!px-4 !space-y-20">
        ...
        <HomeAlbumOverview
          isVideoRight
          videoId={theMonkeyMothershipVideoId}
          albumMeta={theMonkeyMothershipData}
        />
        <HomeAlbumOverview
          isVideoRight={false}
          videoId={HMVideoId}
