...
'너에게 내 모든 권능을 주고, 그 영광은 네가 가질 수 있게 해주겠다. 대신 나머지 모든 것들은 언제든 잃어버리게 될 것이다.'

당신은 별 대수롭지 않게 여기며 그의 제안을 승낙합니다. 놀랍게도 몇 년을 고민하던 이야기를 쉬이 풀어내게 되었습니다. 당신은 기뻐 금치 못합니다.

하지만 당신은 곧 알게 됩니다. 악마가 취해 간 것들을.

길을 걷다 마주친 고양이들은 두 번 다시 눈길을 주지 않습니다. 해가 졌음에도 당신은 달콤한 잠에 들지 못합니다. 한때 같이 걷고, 같이 잠었지만 이들이 이제는 당신을 피해 달아나는 무수한 사람들을 보게 됩니다.

악마는 참 잔인하게도 기억은 잃지 못하게 하는 장치를 심어 두었습니다. 그 모든 이별에도 당신은 살아가고, 살아버립니다. 참 불쌍하네요, 우린.`,
        tags: [],
      },
      {
        trackNo: 2,
...
있잖아, 기다리지..., 뜨문 뜨문 뜨문.`,
      ...
      },
      {
        ...
        lyrics: `Have I been thrown away? In a six-sides mirrored room.
Stand in an aisle, 2 mothers in my view.

My twin, you’ve grown up quite a lot, Then Haven’t I ?
Stand in an aisle, 2 mothers in my view.
...
Oh, I was thrown away, but you are here now.
...
exploded
in silence
Beef beef beef I want more beef.
...
아주 천천히, 하지만 묵직하게 앨범의 시작을 여는 곡이다. ‘내 딸아. 너는 색깔을 알아볼 수 없으니 세상을 바라볼 수 있겠느냐? 고로 특별해지려 하지 말거라, 내가 세상을 살아봐서 세상을 알기 때문이란다.’ 누구보다 평범하게 살기를 바라왔지만 평범한 것이 제일 힘든 것임을. 범인(凡人)이 되지 못한다면 선택지는 두 가지이다. 세상의 주연이 되거나 엑스트라가 되거나. 아버지로 대표되는 절대자는 나에게 비범함을 좇지 말라 했다.
그래서 나는 선택했다, 엑스트라로 남을 것을. 하지만 ‘extraordinary’하게 살 것을. 이 노래가 리버스된 샘플의 심연을 돌다 기타와 피아노가 들어오며 화음을 찾고 갈피를 잡는 것처럼.

2. Only Space

오래전부터 고독에 대한 이야기를 하고 싶었다. 혼자되는 것을 무서워하는 사람들, 고독을 고통으로 받아들이는 사람들을 자주 봐오며 가진 생각이다. 나의 부족함으로 인해 고독 이야기가 정체되던 와중 책을 선물받았다. 라이너 마리아 릴케가 시인을 꿈꾸던 프란츠 크사버 카푸스와 나눈 편지를 엮은 〈젊은 시인에게 보내는 편지〉. 릴케는 내가 모르는 것을 알고 있었고 그녀의 말을 빌려 내 이야기를 채워 나가기로 했다. 고독은 피해야 하는 것이 아니다. 사람은 외로이 있을 때 심장 가장 깊은 곳을 파고들 수 있게 된다. 수많은 고민에 대한 해답은 그 아래 침전물 속에 있고. 고로 고독은 친구이자 선생님이며 거울이다.
곡의 시작부터 끝없이 이어지는 불협화음은 처음엔 부담스레 다가올지라도 이내 그 속을 유영하는 스스로를 발견할 수 있게 할 것이다. 외로움도 마찬가지이다. 오롯이 혼자 있는 시공간은 처음엔 나를 옥죄는 것처럼 보이지만, 곧 나의 가장 깊은 곳을 자유롭게 떠돌아다닐 수 있게 한다. 중후반부터 시작되는 제임스 블레이크 스타일의 공격적인 신디사이저 소리와 몸을 타고 울리는 극저음, 점점 강렬해지는 드럼 사운드를 통해 감히 라디오헤드와 포티스헤드의 곡들이 주는 무아지경을 흉내내보고 싶었다. 이 곡을 듣는 사람들도 노래가 주고 있는 그 무아지경 속에 빠져 ‘나만의 공간으로 너그럽게 조용히 하지만 확신에 차서 들어가는’ 기회를 가졌으면 한다.

3.  ≒  (가을같은겨울)

나도 사랑을 노래하고 싶었다. 하지만 이 노래는 사랑을 이야기하지 않는다. ‘≒(가을같은겨울)'은 내가 가장 처음 만든 노래이다. 이 곡을 처음 만들기 시작했을 때는 연애에 관한 가사들로 채워져 있었다. 하지만 일련의 사건들로 인해 나에게 사랑이란 단어는 고통의 범주에 들어가 버린 어떤 것이 되었고 이 노래는 결국 사랑을 이야기하지 못했다. 사랑이 무엇인지 모르게 되었다. 아니, 예전에 알고 있던 그것이 사랑이었는지조차 모르겠다. 연애 이야기를 떠벌리기에 나는 너무 부끄러운 몸이 되었다. 그렇다고 멈출 수는 없었다. 수치스러움과 고통을, 여타 사랑의 찌꺼기들을 창작의 원동력으로 삼았다. 그렇게 사랑의 부산물들을 주워담은 나의 ‘부끄러운’ 첫 노래는 인간의 외로움과 우울함을 말하게 되었고, 두 가지의 새로운 감정은 나의 지향점이 되었다.
7살이 된 이 노래는 어쿠스틱 기타 한 대로 시작해서 여러 번의 편곡 과정을 거쳤는데, 본 이베어 특유의 중첩된 보컬 사운드와 욘시, 비욬의 음악이 주는 감성을 좋아한다면 이 노래도 좋아할 것이다.

4. 엔터테이나

이 노래는 반성의 노래이다. 이유가 기억나지 않는 고민에 빠져있던 나에게 친구는 티켓을 하나 선물해줬다. 동춘서커스 입장권. 이게 뭐냐고 코웃음치던 나는 시간이나 때울 겸 다음날 저녁 공연장으로 가 자리에 앉았다. 조명이 켜지고 한참 뒤 다시 조명이 꺼졌다. 그날 밤 집으로 곧장 돌아온 나는 홀린 듯이 가사를 써내려갔다.
서커스 단원들의 노력은 진짜였고 나의 그것은 가짜였다. 노래하는 척, 예술하는 척만 배우며 나는 살아왔다. 손발이 찢어져 피가 철철 흐를 정도로 무언가를 해본 적이 있던가? 그들은 있었고 나는 없었다. 부끄러웠다. 진짜 엔터테이너들을 본 후의 그 부끄러움을 조금이라도 만회하기 위해 난 그들처럼 노래하기로 생각했다.
