...
눈물을 흘리는 것은 나약한 일일까? 그렇다 듣고, 또 그렇게 알며 살아왔다.
그러나 이제는 좋은 울음에 대해 이야기해보고 싶다. 달아오르는 눈시울을 자랑스럽게 여기지는 못해도 숨기지는 않겠다.
...
잊혀질 음악 속에 사는 것도 기분이 좋습니다.
도와주신 모든 분들께 감사드립니다.

*
진부하고 진부한 판도라의 상자 이야기를 빗대어 말하고 싶었습니다. 후회하세요, 그리고 슬퍼하세요.
그래도 희망은 남아있습니다, 도대체 왜인지 모르겠지만.

아무쪼록 저는 말이죠, 여전히 같이 울기로 마음먹었습니다.

[Credit]

Produced by Shinhwan @ Phoné Studio, HIMINN
...
All Instruments by HIMINN`,
    contentEn: `The single [Fool’s Box] has been released.
...
*
I wanted to allude to that tired, old tale of Pandora’s box.
...
-2023.03.18 SAT 오후 7시
-신도시 @seendosi (서울특별시 중구 수표동 을지로11길 31 4층)

·가격 : 30,000원 (현매 35,000)
·예매 : 프로필 구글폼 안내

·포스터 : 이녹조 @playnokjo, 조영근 @f1vshbby

※1인셋으로 진행되는 공연입니다.
※입장 시 이어플러그를 배부합니다.
※예매폼은 2월 23일 오후 6시 오픈됩니다.
※입장은 예매순이 아닌 당일 도착순입니다.

🦷기타 문의사항은 BrokenTeeth @brokenteeth99 또는 brokenteeth99@gmail.com으로 전해주세요

—————————————————

Brokenteeth 님의 2집 쇼케이스 공연에 오프닝 무대를 꾸밉니다. 예매는 @brokenteeth99 프로필 내 구글폼을 통해 가능합니다.`,
    contentEn: `BrokenTeeth 2집 '추락은 천천히' 발매 기념 쇼케이스
...
HIMINN 의 정규 앨범 [HM] 의 수록곡을 다른 뮤지션들의 손으로 재조립한 리믹스 앨범
...
Artwork by HIMINN`,
    contentEn: `The remix album of last winter’s full-length ‘HM’ has been released.
...
A remix album where songs from HIMINN’s full-length album [HM]
...
그렇게 한참을 두고 살다가 문득 작년 앨범 발매 직후 속초로 여행을 떠났을 때가 생각났습니다. 정확히는 작은 도시의 한 서점에서 발견한 글귀가.

‘하지만 세상에는 앨범을 만들려고 음악을 시작한 사람들이 있다. 동그란 판 안에 아직 뭘 넣을 수 있는 한 <앨범적 사고>는 계속된다.‘

처음 봤을 때 ‘오…’ 한 번 하고 넘어간 후 여러 핑계로 피지컬 앨범을 계속 미뤄왔는데, 지금 다시 보니까 순간 영 못 할 짓도 아니라는 생각이 들더군요. 불과 1년 전만 해도 ‘앨범 만들기’에 혈안이었으면서 막상 손에 쥘 앨범도 없이 내버려두다니…?

혹자는 요즘 같은 시대에 (누가 시디를 만드냐, 스트리밍으로 들으면 끝인데…) 혹은 더 깊이, (요즘 같은 시대에 누가 앨범을 만드냐, 음악은 영화나 소설이 아니다, 싱글 하나나 제대로 만들어라…)

근데 말이죠, 누가 뭐라고 해도 제 목표는 [근사한 앨범 만들기]입니다. [HM]이 수작이나 평작이란 뜻은 아닙니다. ‘근사’의 꿈을 평생 못 이룰 수도 있지만 <앨범적 사고>를 멈추지는 않겠다는 뜻이죠.

바이닐, 카세트, 시디 모두 음반 산업과 그 구조의 산물이고 각각의 감성은 다 거기에 맞춰 발전되어온 것이긴 하지만, 앨범적 사고에 따라오는 “테마 묶음”이 주는 강력함은 아직까지 수용할 만한 가치( 혹은 사치)라고 생각합니다.

그래서 휴대폰 어플을 키면 초고해상도 무손실로 노래를 들을 수 있는 이 시대에 사치를 좀 부려봤습니다. 혹여나 제 가치/사치 놀음에 한 푼이라도 도움을 주시려는 분들을 위해 별 것 아닌 선물을 넣어뒀습니다. 지금까지 발매한 몇 곡들의 초기 데모인데요. 정제되지 않은 날 것의 맛을 좋아하신다면.. 한 번 정도 들어보셔도 좋을 것 같습니다.

@6v6recordings 의 네이버 스마트스토어에서 구매하실 수 있습니다. 저의 프로필 링크를 통해 방문해주세요. 언제나 그렇듯, 도움주신 분들에게 진심으로 감사드립니다.`,
    contentEn: `It’s been almost a year since I released the full-length album [HM] last December.

Once a song has been "expelled" (I find “distributed” a little too polished to capture the raw finality of it), it’s hard to go back and change anything—it becomes something that belongs entirely to the listener. So usually, I don’t look back.

But recently, I found myself remembering a trip I took to Sokcho right after the album’s release.

More specifically, a phrase I came across in a small bookstore in that quiet town:

"But there are people who began making music just to make albums. As long as there’s still room to fill in that round disc, the ‘album mindset’ will persist."

The first time I read that, I just nodded and moved on. Since then, I’ve made all kinds of excuses to delay the physical release. But looking back now… maybe it wasn’t such a bad idea after all. Just a year ago, I was obsessed with “making an album,” and yet I left it with nothing to hold in my hands?

Some might say, “Who even makes CDs these days? You just stream it and move on.”

Or more critically, “In this day and age, who even makes albums? Music isn’t a film or a novel—just make a decent single.”

But to be honest, no matter what anyone says, my goal is to make good albums. That doesn’t mean [HM] was a masterpiece or even particularly great. I might never achieve my idea of “greatness,” but I’m not ready to let go of the album mindset.

Vinyl, cassette tapes, CDs—they’re all products of the music industry and its systems, and each has its own unique emotional flavor that evolved with it. Still, the power of a thematic collection that comes from thinking in album form is, to me, a meaningful (or perhaps indulgent) thing worth holding onto.

So yes, even in an age where your phone app lets you stream music in ultra-high-resolution lossless audio, I’ve chosen to indulge a little.

And for anyone kind enough to support this indulgence of mine, I’ve included a small gift. A few early demos of previously released tracks. If you enjoy the raw and unrefined, you might like them too—just for a listen.

You can purchase it on 6v6recordings’ Naver Smart Store. The link is in my profile.

As always, I’m deeply grateful to everyone who helped make this possible.`,
  },
  {
    idx: 7,
    type: "performance",
...
대림여인숙이 2023년 12월 2일 단 하루,
대전여인숙으로 변신합니다.

himinn, BrokenTeeth, nokjo의 합동 공연을 소리들에서 만나보세요.

일시 : 23년 12월 2일 토요일 19시 (입장 시작 : 18시 20분)
장소 : 대전 중구 보문로260번길 17, 2층 소리들
입장료 : 9,900원 + 음료 1잔 필수 주문
예매 오픈 : 23년 11월 13일 월요일 20시
예매 방법 : 소리들 링크트리 내 구글 폼 참고
러닝타임 : 약 90분`,
    contentEn: `댊숙 파견근무. 대전에 어쿠스틱 뭐시깽이 셋으로 갑니다.
...
못생겨서 천대받고 버려지던 악마의 생선, 아귀의 신분 상승기.
아귀가 어떻게 죽고 재탄생하는지 확인해보세요.

1부 : 23-12-31 오전 9시 05분
2부 : 24-01-01 오전 8시 30분

MBC경남 지상파 방송과 유튜브 채널 ’엠키타카‘를 통해 시청하실 수 있습니다.`,
    contentEn: `MBC 경남의 특집 다큐멘터리 <악마의생선>에 음악감독으로 참여했습니다.
...
좋은 기회가 1-2년에 한 두번, 한 두번 정도는 찾아오는데 좇지는 않더라도 놓치지는 말아야겠다는 생각도 문득 들었습니다.

8월에 봅시다.
근데 무슨 노래 할지를 못 정했거든요.
도와주세요.
...
각자 자신만의 다른 꿈 속에서 사는 사람들, 그리고 그들이 만들어내는 반짝이는 소리들.
잔잔한 주말 오후, 모두가 꿈을 꿀 수 있는 공연을 만들려고 합니다.
...
———————————————
[공연정보]
일시 : 2024년 11월 3일 일요일 오후 3시
장소 : 홍대 언플러그드 B1 공연장
티켓 : 예매 28,000원 / 현매 30,000원 (70석)
티켓오픈 : 2024년 10월 18일 금요일 오후 5시
(@cafeunplugged @unplugged_stage 프로필 링크를 통해 예매 가능합니다)
*티켓 오픈 전 작성한 폼은 무효처리됩니다.
*기타 자세한 공지사항은 예매폼을 확인해주세요

문의
@philipppss DM
@possibly.mayb3 DM`,
    contentEn: `꿈을 꾸러 홍대에 갑니다. 기타 한 대(와 소박한? 페달보드)를 챙겨갑니다.
...
- 마스터링 : @studio_pho.ne`,
    contentEn: `세계 최초의 김밥 다큐멘터리, MBC 경남 [김밥의 천국]에 음악감독으로 참여했습니다. 두 번이나 좋은 기회를 받았네요.
...
감사합니다.`,
    contentEn: `The full-length album [A Brain In Peace &…] is now available early, exclusively on Maansun.
...
Artwork by namu 나무
    ...
    contentEn: `The album [A Brain In Peace &…] is out now.
